  ...
  return (
    <div className="mt-6">
      ...
      <button
        ...
        className="mt-3 text-sm text-tierra-azul underline hover:text-tierra-bordo transition-colors focus:outline-none focus:ring-2 focus:ring-tierra-azul/40 rounded"
      >
        Ir al carrito
      </button>
    </div>
