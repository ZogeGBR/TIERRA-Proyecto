...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-medium text-tierra-bordo-oscuro mb-6">Proceso de compra</h1>
          ...
          {paso === 1 && (
            <div className="space-y-4">
              <input
                ...
                className="w-full border border-tierra-crema-oscuro rounded px-3 py-2"
              />
              <input
              ...
              <button
                onClick={() => setPaso(2)}
                className="bg-tierra-azul text-white px-6 py-3 rounded-full font-medium"
              >
                Siguiente
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 border rounded px-3 py-3 text-left ${metodoEnvio === "domicilio" ? "border-tierra-bordo" : "border-tierra-crema-oscuro"}`}
                >
                  Envío a domicilio — ${COSTO_ENVIO_REFERENCIAL.toLocaleString("es-AR")}
                </button>
                <button
                  onClick={() => setMetodoEnvio("retiro")}
                  className={`flex-1 border rounded px-3 py-3 text-left ${metodoEnvio === "retiro" ? "border-tierra-bordo" : "border-tierra-crema-oscuro"}`}
                >
                ...
                <>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="w-1/2 border border-tierra-crema-oscuro rounded px-3 py-2"
                    />
                    <input
                      placeholder="Ciudad"
          ...
          {paso === 3 && (
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={cargando}
                className="bg-tierra-naranja text-white px-8 py-3 rounded-full font-medium disabled:opacity-60"
              >
