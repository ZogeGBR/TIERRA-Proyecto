...
export default function AlquilerPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      <h1 className="font-serif text-2xl md:text-3xl font-semibold text-tierra-bordo-oscuro mb-2">Alquiler de equipo de invierno</h1>
      ...
      <div className="bg-white border border-tierra-crema-oscuro rounded-lg p-6 flex flex-wrap gap-4 items-end">
        <div>
          ...
          <select
            ...
            className="border border-tierra-crema-oscuro rounded px-3 py-2 transition-colors focus:outline-none focus:border-tierra-azul focus:ring-1 focus:ring-tierra-azul"
          >
            {TIPOS_EQUIPO.map((t) => (
        ...
        <button onClick={buscar} disabled={cargando} className="btn-primario">
